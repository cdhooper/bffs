...
/* [They changed their minds a couple times on the GRP/OTR 0=not allowed
    thing.  You might want an option to select wether to invert these bits
    on Examine()/SetProtection() or not, at least for now (sigh)]	 */
...
#define FIBB_READ      3	/* ignored by really old filesystem */
#define FIBB_WRITE     2	/* ignored by really old filesystem */
